...
//to more dyanamically data from swiggy api
const restrautList = [
  {
    type: "restaurant",
    data: {
...
//i want to show the different data in my cards, btw it shows same data
// like
//it should be kfc, it should be dominos etc
{
  /* <RestrauntCard  kfc/>
<RestrauntCard  mcdonald/>
<RestrauntCard dominos/> */
}
const Body = () => {
  return (
    <div className="restaurant-list">
      ...
      {/* this above is not good, what if there is 50 restaurant,,so using .map function to looping all */}
